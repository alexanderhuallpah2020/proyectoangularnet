...
@Component({
  ...
  standalone: true,
  imports: [MatButtonModule, RouterLink, MatFormFieldModule, ReactiveFormsModule, MatInputModule, MatDatepickerModule, InputImgComponent, MapaComponent, SelectorMultipleComponent, AutocompleteActoresComponent],
